...
Controls:
---------
Input Mechanism,Action,Functionality
Mouse Left-Click (Hold),Select/Draw,Selects a player-owned troop (best) or city (best_city) and initiates path drawing via MOUSEMOTION.
